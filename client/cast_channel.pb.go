...
type CastMessage struct {
	ProtocolVersion *CastMessage_ProtocolVersion `protobuf:"varint,1,req,name=protocol_version,enum=client.CastMessage_ProtocolVersion" json:"protocol_version,omitempty"`
	...
	PayloadType *CastMessage_PayloadType `protobuf:"varint,5,req,name=payload_type,enum=client.CastMessage_PayloadType" json:"payload_type,omitempty"`
...
type AuthError struct {
	ErrorType        *AuthError_ErrorType `protobuf:"varint,1,req,name=error_type,enum=client.AuthError_ErrorType" json:"error_type,omitempty"`
	XXX_unrecognized []byte               `json:"-"`
}
...
func init() {
	proto.RegisterEnum("client.CastMessage_ProtocolVersion", CastMessage_ProtocolVersion_name, CastMessage_ProtocolVersion_value)
	proto.RegisterEnum("client.CastMessage_PayloadType", CastMessage_PayloadType_name, CastMessage_PayloadType_value)
	proto.RegisterEnum("client.AuthError_ErrorType", AuthError_ErrorType_name, AuthError_ErrorType_value)
}
